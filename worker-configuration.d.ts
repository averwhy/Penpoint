/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 600522f1063cb11b7b2253a968411c7b)
// Runtime types generated with workerd@1.20260815.1 2026-08-15 
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	PUBLIC_BASE_URL: string;
	DATABASE_URL: string;
	PENPOINT_INIT_EMAIL: string;
	PENPOINT_INIT_PASSWORD: string;
	JWT_ACCESS_SECRET: string;
	JWT_ONBOARDING_SECRET: string;
	JWT_RESET_PASSWORD_SECRET: string;
	PUBLIC_CF_TURNSTILE_KEY: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_BASE_URL" | "DATABASE_URL" | "PENPOINT_INIT_EMAIL" | "PENPOINT_INIT_PASSWORD" | "JWT_ACCESS_SECRET" | "JWT_ONBOARDING_SECRET" | "JWT_RESET_PASSWORD_SECRET" | "PUBLIC_CF_TURNSTILE_KEY" | "CF_TURNSTILE_SECRET">> {}
}
